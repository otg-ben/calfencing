...
export default function Contact() {
  ...
  function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    // Show thank-you message after
    setTimeout(() => setSubmitted(true), 100);
    // For static export, we let the form POST to Formspree directly
    // The form action handles the submission
    void form;
  }
        ...
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div>
            ...
            {submitted ? (
              ...
              <form
                action="https://formspree.io/f/xkoqykrj"
                method="POST"
              ...
              >
                ...
                <button
                  type="submit"
                  className="bg-sage text-white px-8 py-3 rounded-sm text-sm tracking-wide hover:bg-sage/90 transition-colors"
                >
                  Send Message
                </button>
              </form>
